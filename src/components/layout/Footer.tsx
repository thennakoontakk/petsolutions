...
export default function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden text-white" style={{ backgroundColor: '#0F121E' }}>
      ...
      {/* 3. MAIN FOOTER NAVIGATION COLUMNS */}
      <div className="container mx-auto px-4 py-12 sm:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10">
          
          {/* Column 1 & 2: Brand Story & Social Media */}
          <div className="lg:col-span-2 space-y-4">
            ...
            {/* Social Icons */}
            <div className="pt-2">
              <p className="text-[10px] uppercase font-bold tracking-wider text-accent mb-3">Connect With Us</p>
          ...
          {/* Column 3: Shop Departments */}
          <div className="space-y-3.5">
            <h4 className="font-heading font-bold text-xs uppercase tracking-wider text-accent border-b border-white/10 pb-2">
              Popular Categories
            </h4>
            <ul className="space-y-2.5 text-xs text-white/70">
              <li>
                <Link href="/products?category=dry-wet-pet-food&pet_type=Dog" className="hover:text-accent hover:translate-x-1 inline-block transition-all">
                  🐶 Dog Food (Dry & Wet)
                </Link>
              </li>
              <li>
                <Link href="/products?category=cat-litter-hygiene" className="hover:text-accent hover:translate-x-1 inline-block transition-all">
                  🐱 Cat Litter & Hygiene
                </Link>
              </li>
              <li>
                <Link href="/products?category=parasite-tick-control" className="hover:text-accent hover:translate-x-1 inline-block transition-all">
                  🛡️ Parasite & Tick Control
                </Link>
              </li>
              <li>
                <Link href="/products?category=medicated-shampoos-grooming" className="hover:text-accent hover:translate-x-1 inline-block transition-all">
                  ✨ Medicated Shampoos
                </Link>
              </li>
              <li>
                <Link href="/products?category=health-supplements" className="hover:text-accent hover:translate-x-1 inline-block transition-all">
                  💊 Health & Supplements
                </Link>
              </li>
              <li>
                <Link href="/products?category=wound-care-topical-pharmacy" className="hover:text-accent hover:translate-x-1 inline-block transition-all">
                  🩹 Wound Care & Pharmacy
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-3.5">
            ...
            <ul className="space-y-2.5 text-xs text-white/70">
              <li>
                <Link href="/products" className="hover:text-accent hover:translate-x-1 inline-block transition-all">
                  Browse All Catalog
                </Link>
              </li>
              <li>
                <Link href="/cart" className="hover:text-accent hover:translate-x-1 inline-block transition-all">
                  My Shopping Cart
                </Link>
              </li>
              <li>
                <Link href="/orders" className="hover:text-accent hover:translate-x-1 inline-block transition-all">
                  Order Tracking & History
                </Link>
              </li>
              <li>
                <Link href="/auth/login" className="hover:text-accent hover:translate-x-1 inline-block transition-all">
          ...
          {/* Column 5: Contact & Operating Hours */}
          <div className="space-y-3.5">
            <h4 className="font-heading font-bold text-xs uppercase tracking-wider text-accent border-b border-white/10 pb-2">
              Contact & Hours
            </h4>
            <ul className="space-y-3 text-xs text-white/70">
              ...
              <li className="flex items-start gap-2.5 pt-1">
                ...
                <div>
                  <p className="text-white font-medium">Daily Hotline Support</p>
                  <p className="text-[11px] text-white/50">8:30 AM – 8:30 PM</p>
                </div>
              </li>
            </ul>
          </div>
